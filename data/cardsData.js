...
const cardsData = [{
    ...
    },
    {
        ...
        transfer4: {
            name: '低温冷萃机',
            energy: 75,
            info: '被冰冻的老鼠在冰冻状态下死亡时，会变成冷萃咖啡；冷萃咖啡每格只生成1个，最多8个，老鼠触碰或在场25s后产生3*3范围爆炸'
        },
        transfer5: {
            name: '迅捷冷萃机',
            energy: 75,
            info: '爆炸后留下3行可以持续伤害老鼠并令其减速的冰渣；冷萃咖啡的爆炸范围扩大至5*5'
        }
    },
    {
        id: 15,
    ...
    },
    {
        ...
        transfer2: {
            name: '南瓜灯',
            energy: 25,
            info: '多生产1朵火苗；放置后眩晕全屏老鼠一段时间'
        },
        transfer3: {
            name: '万圣南瓜灯',
            energy: 25,
            info: '照亮范围扩大至全屏；被老鼠吃掉后在3*3范围内重生一次'
        },
        transfer4: {
            name: '油灯',
            energy: 0,
            info: '不消耗火苗；使3*3十字范围内的卡片隐身，不会被老鼠攻击'
        },
        transfer5: {
            name: '高亮油灯',
            energy: 0,
            info: '使3*3范围内的卡片隐身；在3*3范围内死亡的老鼠会转化为火苗'
        }
    },
    {
        id: 26,
    ...
    },
    {
        ...
        transfer5: {
            name: '青芥末河豚',
            energy: 150,
            info: '前后各增加1根尖刺；被老鼠吃掉后向8个方向各发射1根尖刺'
        }
    },
    {
        id: 29,
    ...
    },
    {
        ...
        rarity: 0,
        energy: 175,
        ability: '投掷一块臭豆腐攻击老鼠；有概率投出毒豆腐，产生3*3十字范围、持续3秒的毒气，每秒减少老鼠2%的生命（毒伤叠加上限10%）',
        reinforcement: {
            info: '提高攻击力'
        },
        skill: {
        ...
        transfer3: {
            name: '邪恶牛油果',
            energy: 175,
            info: '投掷一个牛油果核攻击老鼠，产生3*3范围、持续5秒的毒素诅咒，每秒减少老鼠2%的生命（毒伤叠加上限10%）'
        },
        transfer4: {
            name: '沙沙牛油果',
            energy: 175,
    ...
    },
    {
        ...
        rarity: 3,
        energy: 200,
        ability: '向前方连续4格发射猩红毒针，分裂式穿透攻击；攻击附加5秒毒伤，每秒减少老鼠2%的生命（毒伤叠加上限10%）',
        reinforcement: {
            info: '提高攻击力',
            data: [{
                label: '攻击力',
        ...
        transfer2: {
            name: '天蝎座星宿',
            energy: 200,
            info: '攻击范围扩大至前方连续6格；毒伤叠加上限提高至12%'
        }
    },
    {
        id: 59,
    ...
    },
    {
        ...
        reinforcement: {
            ...
            data: [{
                ...
                {
                    label: '存火比例',
                    data: ['15%', '16%', '17%', '18%', '19%', '20%', '25%', '30%', '35%', '40%', '45%']
                }
            ],
        },
        skill: {
    ...
    },
    {
        ...
        transfer2: {
            name: '小丑猫猫箱',
            energy: 150,
            info: '被吓到的老鼠会受到伤害；强化同时提高攻击力'
        },
        transfer3: {
            name: '弹簧虎',
            energy: 200,
            info: '向前方发射虎头子弹攻击老鼠并将其吓跑至相邻行；被吓到的老鼠会扔掉防具；技能同时提高攻击速度'
        },
        transfer4: {
            name: '飞行弹簧虎',
            energy: 200,
    ...
    },
    {
        ...
        transfer5: {
            name: '香辣红柳烤串机',
            energy: 225,
            info: '每路增加1串红柳烤串；被击杀的老鼠留下1格持续燃烧的火焰'
        }
    },
    {
        id: 116,
    ...
    },
    {
        ...
        transfer1: {
            name: '盛宴丸子厨师',
            energy: 150,
            info: '有概率挥动厨具打飞经过的平射子弹，将其转化为附带眩晕效果的投掷子弹'
        },
        transfer2: {
            name: '传奇丸子厨师',
            energy: 150,
            info: '有概率挥动厨具强化经过的平射子弹，使其能够击飞老鼠'
        }
    },
    {
        id: 123,
    ...
    },
    {
        ...
        energy: 350,
        cd: 15,
        ability: '向前方发射3颗能被火盆（包括转职卡）强化的糖果；每隔10秒在3*3范围内召唤一个小糖马；小糖马向前方投掷1颗附带3*3溅射范围、50%溅射伤害的糖果，15秒后消失',
        reinforcement: {
            info: '提高攻击力',
            data: [{
                    label: '糖人马',
        ...
        transfer2: {
            name: '缤纷糖人马',
            energy: 350,
            info: '额外向后发射3颗糖果；小糖马的存在时间延长至25秒'
        }
    },
    {
        id: 151,
