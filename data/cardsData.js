...
const cardsData = [{
    ...
    },
    {
        ...
        rarity: 0,
        energy: 175,
        ability: '投掷一块臭豆腐攻击老鼠；有概率投出毒豆腐，产生3*3十字范围、持续3秒的毒气，每秒减少老鼠2%的生命（毒气叠加上限8%）',
        reinforcement: {
            info: '提高攻击力'
        },
        skill: {
        ...
        transfer3: {
            name: '邪恶牛油果',
            energy: 175,
            info: '投掷一个牛油果核攻击老鼠，产生3*3范围、持续3秒的毒气，每秒减少老鼠2%的生命（毒气叠加上限10%）'
        },
        transfer4: {
            name: '沙沙牛油果',
            energy: 175,
    ...
    },
    {
        ...
        rarity: 3,
        energy: 200,
        ability: '向前方连续4格发射猩红毒针，分裂式穿透攻击；攻击附加3秒毒伤，每秒减少老鼠2%的生命（毒伤叠加上限10%）',
        reinforcement: {
            info: '提高攻击力',
            data: [{
                label: '攻击力',
