...
const cardsData = [{
    ...
    },
    {
        ...
        transfer1: {
            name: '热狗大炮',
            energy: 225,
            info: '攻击力提高40%；对空发射2粒炮弹，对地发射1粒炮弹；炮弹附带减速效果'
        },
        transfer2: {
            name: '热狗高射炮',
            energy: 225,
        ...
        transfer4: {
            name: '伯爵蚝油双菇',
            energy: 225,
            info: '攻击力提高40%；可以同时攻击本行空中和陆地老鼠；对空发射4个蘑菇，对地发射2个蘑菇；对地子弹能被火盆（包括转职卡）强化'
        },
        transfer5: {
            name: '皇家蚝油双菇',
            energy: 225,
    ...
    },
    {
        ...
        energy: 300,
        cd: 30,
        ability: '召唤2枚金币巧克力攻击全场最近的陆地、空中老鼠，造成3*3范围群体伤害；金币巧克力落地后可以阻挡老鼠前进',
        reinforcement: {
            info: '提高攻击力',
            data: [{
                label: '攻击力',
    ...
    },
    {
        ...
        reinforcement: {
            ...
            data: [{
                label: '冷却时间',
                data: [50, 48, 47, 46, 45, 43, 41, 39, 37, 35, 32]
            }]
        },
        transfer1: {
            name: '厨圣蛇羹煲',
